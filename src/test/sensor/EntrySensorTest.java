...
public class EntrySensorTest {
	
	private EntrySensor sensor;
	...
	@Test
	public void testEntrySensor() throws FileNotFoundException {
		File file = new File("src/model/config.txt");
		BaseStation station = new BaseStation(file);
		EntrySensor sensor = new EntrySensor(station, 0);
