...
public class CarbonMonoxideSensorTest {
	
	private CarbonMonoxideSensor sensor;
	...
	public void setUp() throws Exception {
		...
		sensor = new CarbonMonoxideSensor(station, 0);
	}
	...
	@Test
	public void testCarbonMonoxideSensor() throws FileNotFoundException {
		File file = new File("src/model/config.txt");
		BaseStation station = new BaseStation(file);
		CarbonMonoxideSensor sensor = new CarbonMonoxideSensor(station, 0);
